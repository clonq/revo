...
const LOCAL_THEMES_REPO = REVO_HOME+'/repo/themes';
            ...
            install: function(path, theme) {
                return new Promise(function(resolve, reject){
                    ...
                    if(!util.isDir(localThemeDir)) {
                        ...
                        return installTheme(path, theme);
                    }
                });
            }
        },
        //todo: determine if theme needs to be instaled from local filesystem or fetched from url
    },
