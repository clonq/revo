...
dir = dir.substring(0, dir.lastIndexOf('/'));
const REVO_HOME = dir;
// const REVO_HOME = process.cwd();
const LOCAL_REPO_ROOT = REVO_HOME+'/repo';
...
const LOCAL_RECIPES_REPO = REVO_HOME+'/repo/recipes';
const LOCAL_APPS_REPO = REVO_HOME+'/repo/apps';
const LOCAL_COMPONENTS_REPO = REVO_HOME+'/repo/components';
...
module.exports = {
    ...
    recipe: {
        ...
        load: function(name) {
            var yamlRecipeFilename = 'repo/recipes/'+name+'.yaml';
