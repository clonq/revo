    ...
    deployApp: function(opts) {
        ...
        .then(function(recipe){
            ...
            var sshopts = {
                ...
                path: target.path||'.',
                method: target.method||'scp',
                cmd: 'tar xvf '+zipFilename.substring(zipFilename.lastIndexOf('/')+1)
            }
            if(sshopts.method === 'scp') {
                ...
                console.log(ERROR('unknown deployment method '+sshopts.method));
            }
        });
    }
