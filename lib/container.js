...
function initializeComponents() {
    ...
    try {
        ...
        // var coreComponents = ['revo/webbridge'];//todo: unhardcode
        // for(componentName in coreComponents) {
        //  process.removeAllListeners(coreComponents[componentName].emit);
        //  debug('processing core component', componentName);
        // }
        // // init recipe components
