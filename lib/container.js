...
module.exports = {
    ...
    start: function(config) {
		...
		eventServer.on('web', function(payload){
debug(':>>>', this.event, payload);
		});

		eventServer.emit('web', 'test');
		process.emit('web', 'another test');
		var ee = require('events').EventEmitter;
		ee('web', 'and yet another test');
// 		process.on('bootstrap', function(payload){
// debug('>>>>>>>', payload)			
// 		});
